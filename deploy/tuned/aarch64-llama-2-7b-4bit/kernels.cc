...
extern "C"
 ...
 int32_t qgemm_lut_t1_int8_m1024_k4096_n1_b4(void* A, void* LUT, void* Scales, void* LUT_Scales, void* LUT_Biases, void* C) {
  ...
  for (int32_t k_outer = 0; k_outer < 64; ++k_outer) {
    tbl_g4_int8_float_update_strue_k16_b4_ak16_fafalse_ztrue_osfalse(1024, (&(((half*)CBits)[0])), (&(((int8_t*)LUT_1)[(k_outer * 256)])), (&(((uint8_t*)A_1)[(k_outer * 8192)])), (&(((half*)Scales_1)[((k_outer >> 1) * 512)])), (&(((half*)LUT_Scales_1)[k_outer])), (&(((half*)LUT_Biases_1)[k_outer])));
  }
...
extern "C"
 ...
 int32_t qgemm_lut_t1_int8_m256_k4096_n1_b4(void* A, void* LUT, void* Scales, void* LUT_Scales, void* LUT_Biases, void* C) {
  ...
  for (int32_t k_outer = 0; k_outer < 64; ++k_outer) {
    tbl_g4_int8_float_update_strue_k16_b4_ak16_fafalse_ztrue_osfalse(256, (&(CBits[0])), (&(((int8_t*)LUT_1)[(k_outer * 256)])), (&(((uint8_t*)A_1)[(k_outer * 2048)])), (&(((half*)Scales_1)[((k_outer >> 1) * 128)])), (&(((half*)LUT_Scales_1)[k_outer])), (&(((half*)LUT_Biases_1)[k_outer])));
  }
