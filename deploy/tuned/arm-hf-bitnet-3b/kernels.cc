...
extern "C"
 ...
 int32_t qgemm_lut_t1_int8_m128_k8640_n1_b2(void* A, void* LUT, void* Scales, void* LUT_Scales, void* LUT_Biases, void* C) {
  ...
  void* A_1 = (A);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_A_shape = (NULL);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_A_strides = (NULL);
  int32_t dev_id = (0);
  void* LUT_1 = (LUT);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_shape = (NULL);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_strides = (NULL);
  void* Scales_1 = (Scales);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_Scales_shape = (NULL);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_Scales_strides = (NULL);
  void* LUT_Scales_1 = (LUT_Scales);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_Scales_shape = (NULL);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_Scales_strides = (NULL);
  void* LUT_Biases_1 = (LUT_Biases);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_Biases_shape = (NULL);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_Biases_strides = (NULL);
  void* C_1 = (C);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_C_shape = (NULL);
  void* qgemm_lut_t1_int8_m128_k8640_n1_b2_C_strides = (NULL);
  if (!(qgemm_lut_t1_int8_m128_k8640_n1_b2_A_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m128_k8640_n1_b2_Scales_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_Scales_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m128_k8640_n1_b2_LUT_Biases_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m128_k8640_n1_b2_C_strides == NULL)) {
  }
